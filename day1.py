...
def replace_words_with_digits(input: str):
...
def match_word(input: str, start: bool, i: int):
    if input.startswith("one", i) or input.endswith("one", i):
        return 1
    if input.startswith("two", i):
        return 2
    if input.startswith("three", i):
        return 3
    if input.startswith("four", i):
        return 4
    if input.startswith("five", i):
        return 5
    if input.startswith("six", i):
        return 6
    if input.startswith("seven", i):
        return 7
    if input.startswith("eight", i):
        return 8
    if input.startswith("nine", i):
        return 9


def find_first_digit(input: str):
...
def test_find_first_digit():
    assert find_first_digit("oneight") == 1
    assert find_first_digit("3") == 3
    assert find_first_digit("3five") == 3
    assert find_first_digit("fivethree") == 5
    assert find_first_digit("eightwothree") == 8


def test_find_last_digit():
    assert find_last_digit("oneight") == 8
    assert find_last_digit("3five4") == 4
    assert find_last_digit("five5three") == 3
    assert find_last_digit("eightwothree") == 3
...
def test_find_number():
    ...
    assert find_number("nineeight") == 98
    assert find_number("nineight") == 98
...
def find_number(input: str):
    first_num = find_first_digit(input)
    last_num = find_last_digit(input)
